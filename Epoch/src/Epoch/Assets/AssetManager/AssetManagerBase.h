...
namespace Epoch
{
	...
	public:
		...
		virtual void AddMemoryOnlyAssetWithName(std::shared_ptr<Asset> aAsset, const std::string& aName) = 0;
		virtual void AddMemoryOnlyAssetWithHandle(std::shared_ptr<Asset> aAsset, const std::string& aName) = 0;
